...
;--------------------------------------------------------------------------------------------------
; Ensambladas a partir de direccion 24500. La primera instruccion BASIC debe ser memory 23999 para
; colocar HIMEM en 23999 y asi no machacar las rutinas que comienzan en 20500
...
;  SAVE "8BP.lib",b,24000,7700  version de 8BP especifica de tu juego. es necesario hacerla
