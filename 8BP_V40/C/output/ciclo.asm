...
;ciclo.c:81: _basic_border(7);
	...
	call	__basic_border
	inc	sp
;ciclo.c:82: _basic_sound(1,100,14,0,0,1,0);
	xor	a, a
	ld	d,a
	ld	e,#0x01
	push	de
	...
	add	hl, sp
	ld	sp, hl
;ciclo.c:83: puntos=puntos-1;
	ld	hl, (_puntos)
	dec	hl
	ld	(_puntos), hl
;ciclo.c:84: _8BP_setupsp_3(cod,0,9);
	ld	hl, #0x0009
	push	hl
	ld	l, #0x00
	push	hl
...
;ciclo.c:85: _basic_locate(7,1);
	...
	pop	af
	pop	af
;ciclo.c:86: _basic_print(_basic_str(puntos));
	ld	hl, (_puntos)
	push	hl
	call	__basic_str
	ex	(sp),hl
	call	__basic_print
	pop	af
;ciclo.c:87: goto _label_250;
	jp	00122$
00114$:
;ciclo.c:90: else _basic_border(0);
	xor	a, a
	push	af
	inc	sp
	call	__basic_border
	inc	sp
;ciclo.c:91: if (c %20 ==0) {
	ld	hl, #0x0014
	push	hl
	ld	hl, (_c)
	push	hl
...
;ciclo.c:93: _basic_locate(7,1);
	...
	pop	af
	pop	af
;ciclo.c:94: _basic_print(_basic_str(puntos));
	ld	hl, (_puntos)
	push	hl
	call	__basic_str
	ex	(sp),hl
	call	__basic_print
	pop	af
;ciclo.c:95: t2=t1;t1=_basic_time();
	ld	hl, (_t1)
	ld	(_t2), hl
	call	__basic_time
;ciclo.c:96: fps=6000/(t1-t2);
	ld	(_t1), hl
	ld	bc, (_t2)
	cp	a, a
	sbc	hl, bc
	...
	pop	af
	ld	(_fps), hl
;ciclo.c:97: _basic_locate(17,1);_basic_print(_basic_str(fps));
	ld	hl, #0x0001
	push	hl
	ld	l, #0x11
	push	hl
...
;ciclo.c:100: if (c %5 ==0){
	...
	or	a, l
	jr	NZ,00122$
;ciclo.c:101: _8BP_setupsp_3(i,9,19);_8BP_setupsp_4(i,5,4,_basic_rnd(3)-1);
	ld	hl, #0x0013
	push	hl
	ld	l, #0x09
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:102: _8BP_setupsp_3(i,0,11);_8BP_locatesp_3(i,10,_basic_rnd(80));
	ld	hl, #0x000b
	push	hl
	ld	l, #0x00
	push	hl
...
;ciclo.c:103: i=i+1;if (i==30) i=0;
	...
	ld	hl, #0x0000
	ld	(_i), hl
;ciclo.c:106: _label_250:
00122$:
;ciclo.c:107: if (c<500) goto label_CICLO;
	ld	iy, #_c
	ld	a, 0 (iy)
	sub	a, #0xf4
	ld	a, 1 (iy)
	...
	sbc	a, #0x81
	jp	C, 00101$
;ciclo.c:109: _8BP_poke_2(42038,puntos);
	ld	hl, (_puntos)
	push	hl
	ld	hl, #0xa436
	push	hl
