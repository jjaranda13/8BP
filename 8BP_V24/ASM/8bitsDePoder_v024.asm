...
;================================================================================================================
; V24 
; comenzamos en 26000 con el mapa del mundo, que ocupa 500 bytes
; usarlo implica un memory 25999 en lugar de un memory 26999
; el mapa se ha cargado en la direccion 26000 y puede almacenar hasta 82 elementos
;================================================================================================================
org 26400
...
_END_26400; estamos en 26692. quedan 308 bytes hasta la direccion 27000
;======================================================================
; AREA DISPONIBLE = 308 bytes para mejoras futuras
;=============================================================================================================
...
SPR_mode	db 0; 0=write, 1=readbuffer							***
SPR_addr	dw 0; direccion del sprite en la spritetable					***
SPR_yorig	dw 0; coord y
SPR_xorig	dw 0; coord x

SPR_aux		dw 0;
SPR_offset	dw 0; es spritefinal - sprite_data. si no hay clipping son iguales
...
;SOR_list	db 15; por defecto es 15 (lo cual es ordenar 16)
