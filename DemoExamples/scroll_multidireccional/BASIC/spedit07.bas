...
41 restore:gosub 4000:' carga rutina get INK
50 MODE 1

80 PEN 1:PRINT "    SPEDIT: Sprite Editor v2.0"
90 PRINT "" 
...
280 MODE 0: GOSUB 2030:PEN blanco:'AMARILLO
281 BORDER fondo
...
836 IF b$="x" THEN cosa=cosa+1:IF cosa=27 THEN cosa=26 ELSE INK tinta,cosa: if p$="3" THEN ink tinta+1,cosa
837 IF b$="z" THEN cosa=cosa-1:IF cosa=-1 THEN cosa=0 ELSE INK tinta,cosa:if p$="3" THEN ink tinta+1,cosa
...
1210 a=(PEEK(dirorig) AND &X01010101):'pixel izq
1220 b=(PEEK(dirorig) AND &X1010101):'pixel derecho
...
1510 a=(PEEK(dirorig) AND &X01010101)
1520 b=(PEEK(dirorig) AND &X1010101)
