...
_UPDATE_SEGMENT
	...
	; MEJORA v27
	;-----------------------------------
		; si el numero de pasos es 255 entonces es que es una ruta que no cicla
		
		cp 255
		JR NZ, ROU_normal
		; estamos aqui por que es 255. lo que viene a continuacion es un status
		inc HL; apunta al estado
...
;		pop hl
		...
		cp a,5; patron corto. deberia haber dos tipos de patrones cortos
		jr nz, ink8
