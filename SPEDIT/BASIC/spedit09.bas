10 MEMORY 23899
20 DEFINT a-z
30 buffer=24000: REM buffer de copia de pantalla 
...
781 IF b$="1" AND tinta>2 AND (p$="3" OR p$="4") THEN tinta=tinta-1
790 IF b$="2" THEN tinta=tinta+1:IF tinta>15 THEN tinta=15
791 IF b$="2" AND tinta>2 AND (p$="3" OR p$="4") THEN tinta=tinta+1:IF tinta>14 THEN tinta=14
