...
; ------------------------------------------------
;   ASSEMBLING_MODE  0 --> PRINT_LAYOUT, COLAY commands available. suitable for laberinth games
;   ASSEMBLING_MODE  1 --> MAP2SP, UMA  commands available. suitable for scroll games
...
; function body
;===============
_PRINT_LAYOUT ; va en la misma direccion
_UPDATE_MAP
_UMA
...
_PRINT_LAYOUT
_UPDATE_MAP ; va en la misma direccion
