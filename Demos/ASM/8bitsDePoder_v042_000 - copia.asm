...
if ASSEMBLING_OPTION = 0 ; juegos de layout
...
org 25000
  ...
  _AJUSTA_SEGMENTO	;option 2
  _3D_PROYECTA_XY	;option 2
  _3D_GET_ZOOM_IMAGE	;option 2
  _3D_PAINT_SEGMENT	;option 2
  _RENDER3D
  _3D_RENDER3D 		;option 2
  _UPDATE_MAP		;option 1
  _MAP2SP		;option 1
			ret 
...
if ASSEMBLING_OPTION = 1 ; scrolling
org 24800
...
if ASSEMBLING_OPTION = 2 ; scrolling + 3d
...
;===============================================================================================
_;_INSTALL_RSX2 V42 lo he quitado de aqui
...
; ASSEMBLING_MODE
;==========================================================================================================
; FROM VERSION V42 THERE ARE TWO ASSEMBLING MODES
; ------------------------------------------------
;   ASSEMBLING_MODE  0 --> PRINT_LAYOUT, COLAY commands available. suitable for laberinth games, ORG 25000
;   ASSEMBLING_MODE  1 --> MAP2SP, UMA  commands available. suitable for scroll games , ORG 24804
;   ASSEMBLING_MODE  1 --> MAP2SP, UMA, 3D  commands available. suitable for scroll & 3D games , ORG 24000

; map2sp y colay van a la misma direccion
;_MAP2SP
;_COLISION_LAYOUT
; y despues updatemap (UMA) y printlayout van tambien a la misma

if ASSEMBLING_OPTION = 0 ; layout games
...
;if (ASSEMBLING_OPTION = 1) OR (ASSEMBLING_OPTION = 2); scrolling
if cosa=1 
