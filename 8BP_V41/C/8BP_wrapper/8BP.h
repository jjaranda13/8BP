...
__asm   
     _3D        == 0x645A;//0x646c
     ANIMA      == 0x6fc9;//0x6fc5
     ANIMALL    == 0x7713;//0x770d;//0x7709
     AUTO       == 0x7181;//0x717b;//0x7155
     AUTOALL    == 0x71cf;//0x71c9;//0x71C5
     COLAY      == 0x71fe;//0x71f8;//0x71F4
     COLSP      == 0x73a9;//0x73a3;//0x739F
     COLSPALL   == 0x75ae;//0x75a8; //0x75A4
     LAYOUT     == 0x705f;//0x7059;//0x7055
     LOCATESP   == 0x6C71
     MAP2SP     == 0x6496;//0x64A8
     MOVER      == 0x753b;//0x7535;//0x7531
     MOVERALL   == 0x76ed;//0x76e7;//0x76E3
     MUSIC      == 0x6F55
     PEEK       == 0x692e;//0x6932
     POKE       == 0x6941;//0x6945
     PRINTAT    == 0x606d;//0x607F
     PRINTSP    == 0x6C94
     PRINTSPALL == 0x62aa;//0x62BC
     RINK       == 0x762d;//0x7627;//0x7623
     ROUTESP    == 0x65f4;//0x6606
     ROUTEALL   == 0x65d3;//0x65E5
     SETLIMITS  == 0x686d;//0x6871
     SETUPSP    == 0x70fe;//0x70f8;//0x70F4
     STARS      == 0x7439;//0x7433;//0x742F
     UMAP       == 0x5f38;//0x5F4A
