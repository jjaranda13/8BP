...
;read "../MUSIC/sp_music0002.mus.asm" ;
read "../MUSIC/sp2_music005.mus.asm"
; archivos de musica
SONG_0:
;INCBIN	"../MUSIC/montoya7_v2.mus" ;
;INCBIN	"../MUSIC/sp_music0002.mus" ;
INCBIN	"../MUSIC/sp2_music005.mus" ;
;INCBIN	"../MUSIC/fase2_04.mus" ;
SONG_0_END:


SONG_1:
INCBIN	"../MUSIC/planets_07.mus" ;
SONG_1_END:

SONG_2:
INCBIN	"../MUSIC/fase2_08.mus" ;
SONG_3:
SONG_4:
SONG_5:
SONG_6:
