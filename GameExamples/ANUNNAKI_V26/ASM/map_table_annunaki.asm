...
; en el juego anunnaki no se usa la map table. lo hice antes de incorporar esta funcionalidad a la libreria
; este es solo un fichero de ejemplo
...
db 13;26;13; numero de elementos del mapa a considerar. como mucho debe ser 64
...
;dw 160,120,MONTUP;2
;dw 172,130,MONTUP;2
;dw 172,140,MONTDW;64
;dw 160,160,MONTH;64
;dw 160,180,MONTDW;64
;dw 148,190,MONTDW;64
;REPE 100
;dw 148,210,MONTUP;64
;dw 160,230,MONTUP;2
;dw 172,240,MONTUP;2
;dw 172,250,MONTDW;64
;dw 160,270,MONTH;64