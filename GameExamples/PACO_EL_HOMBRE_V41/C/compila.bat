...
sdcc -mz80 --verbose --code-loc 17500 --data-loc 0 --no-std-crt0 --fomit-frame-pointer --opt-code-size -I8BP_wrapper -Imini_BASIC -o output/ ciclo.c 
...
managedsk -L"output\ciclo.dsk" -I"output\ciclo.bin"/CICLO.BIN/BIN/17500 -S"output\ciclo.dsk"
