...
MAX_SP_WIDTH 	dw 0; ancho maximo de cualquier map item. debe expresarse como numero negativo
MAPITEMS db 0;49 ;36; numero de elementos del mapa a considerar. como mucho debe ser 82
