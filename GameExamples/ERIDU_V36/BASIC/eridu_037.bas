...
700 CALL &64A7,0,m:CALL &71A9,1:CALL &62B8:CALL &7589:IF cor<32 THEN GOSUB 1020:IF reiniciar THEN RETURN
...
720 IF e(n) THEN cosp=cosp MOD 7+20:CALL &70D7,cosp,0,139:CALL &70D7,cosp,15,e(n):CALL &6605,cosp,e(n+3):CALL &6C88,cosp,e(n+1),e(n+2)
...
960 CALL &70D7,disp,0,233:CALL &70D7,disp,15,0:CALL &6C88,disp,y+6,x-8:demora=7
...
990 CALL &70D7,28,0,233:CALL &70D9,28,15,9:CALL &6C88,28,y+6,x:RETURN

'1000 CALL &70D9,27,0,233:CALL &70D9,27,15,9:CALL &6C88,27,y+6,x:RETURN
1000 CALL &70D7,27,0,233:CALL &70D7,27,15,9:CALL &6C88,27,y+6,x:RETURN
...
1130 RETURN
1140 '--- MUERTE NAVE
1141 |COLSP,34,3,2:|COLSP,31:|COLSP,34,0,1: if cod=32 then return
1150 cicloaux=ciclo
