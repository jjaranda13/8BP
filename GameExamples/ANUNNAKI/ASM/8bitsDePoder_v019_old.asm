...
COS2param	ld a, (IX+2); leo el sprite id
		cp 32
		JP M,COS_OK ; si es negativo es que es un sprite 0..31
		JR Z, COS_conflimit
		; si estamos aqui es que sprite= 33
		; nos estan pasando la direccion de la variable de colision
		ld l, (IX+0)
		ld h, (IX+1)
		ld (COS_return_var),hl
		ret

COS_conflimit	; si sprite es 32 entonces es el comando de configuracion
